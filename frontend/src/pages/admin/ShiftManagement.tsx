...
import EditShiftForm from '../../components/admin/EditShiftForm';
...
const ShiftManagement: React.FC = () => {
  ...
  // Get users for the dropdowns and table display
                ...
                <div className="text-center">
                  ...
                  <div className="bg-primary-50 dark:bg-primary-900 p-4 rounded-md mb-6 text-left">
                    <p className="text-sm text-primary-700 dark:text-primary-300">
                      ...
                      User ID: {selectedShift.userId}<br />
                      Duration: {new Date(selectedShift.startDate).toLocaleString()} - {new Date(selectedShift.endDate).toLocaleString()}
                    </p>
                  </div>
